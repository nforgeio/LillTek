...
// DESCRIPTION: Implements the Message Queue Service.
...
{
    /// <summary>
    /// Implements the Message Queue Service.
    /// </summary>
    public sealed class AppService : ServiceBase, IService
    {
        ...
        private MsgQueueHandler     handler;        // The message queue service handler
        ...
        public string Name
        {
            get { return Const.MessageQueueName; }
        }
        ...
        public void Stop()
        {
            lock (syncLock)
            {
                ...
                SysLog.LogInformation("Message Queue Service Stop");
                SysLog.Flush();
