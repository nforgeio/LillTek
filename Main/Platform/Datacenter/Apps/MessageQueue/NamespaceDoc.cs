...
{
    /// <summary>
    /// Implements the message queue service which is responsible for
    /// storing and forwarding messages between applications.
    /// </summary>
    /// <remarks>
    ...
    /// </para>
    /// <para>
    /// See <see cref="MsgQueueHandler" /> for service specific settings.
    /// </para>
    /// </remarks>
