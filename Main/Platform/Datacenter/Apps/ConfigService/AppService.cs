...
// DESCRIPTION: Implements the Config Service.
...
namespace LillTek.Datacenter.ConfigService
{
    ...
    public sealed class AppService : ServiceBase, IService
    {
        ...
        private ConfigServiceHandler    handler;        // The config service application handler
        ...
        public string Name
        {
            get { return Const.ConfigServiceName; }
        }
