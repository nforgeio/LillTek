...
{
    /// <summary>
    /// Implements the Dynamic DNS client service which is responsible for 
    /// registering host entries with one or more dynamic DNS servers.
    /// </summary>
    /// <remarks>
    ...
    /// </para>
    /// <para>
    /// See <see cref="DynDnsClientSettings" /> for service specific settings.
    /// </para>
    /// </remarks>
