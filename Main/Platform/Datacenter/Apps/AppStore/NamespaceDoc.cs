...
{
    /// <summary>
    /// Implements the application store service which is responsible for the storage
    /// and distribution of application executable packages.
    /// </summary>
    /// <remarks>
    ...
    /// </para>
    /// <para>
    /// See <see cref="AppStoreHandler" /> for service specific settings.
    /// </para>
    /// </remarks>
