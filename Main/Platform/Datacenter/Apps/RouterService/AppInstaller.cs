...
// DESCRIPTION: Handles the installation of the Router service.
...
{
    /// <summary>
    /// Handles the installation of the Router service.
    /// </summary>
    [RunInstaller(true)]
    public class AppInstaller : System.Configuration.Install.Installer
    {
        ...
        public AppInstaller()
        {
            ...
            installTools = new InstallTools(Const.RouterServiceName + " Setup", installFolder, "RouterServiceInstall.cmd");
            ...
            this.serviceInstaller.DisplayName      = Const.RouterServiceName;
            this.serviceInstaller.ServiceName      = Const.RouterServiceName;
            ...
            installTools.StartService(Const.RouterServiceName);

            // Add the service description to the registry.

            installTools.AddRegValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\" + Const.RouterServiceName + @":Description",
                                     "Implements the hub/root message router service.");
        ...
        public override void Install(IDictionary state)
        {
            ...
            installTools.InstallIniFile("LillTek.Datacenter.RouterService.ini");
            NativeSysLogProvider.CreateLogs(Const.RouterServiceName);
        }
        ...
        {
            NativeSysLogProvider.RemoveLogs(Const.RouterServiceName);
