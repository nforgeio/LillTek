...
{
    /// <summary>
    /// Implements the LillTek Heartbeat service which is responsible for 
    /// monitoring the health of one or more configured websites.
    /// </summary>
    /// <remarks>
    ...
    /// </para>
    /// <para>
    /// See <see cref="HeartbeatHandler" /> for service specific settings.
    /// </para>
    /// </remarks>
