...
// DESCRIPTION: Handles the installation of the Heartbeat service.
...
namespace LillTek.Datacenter.HeartbeatService
{
    /// <summary>
    /// Handles the installation of the Heartbeat service.
    /// </summary>
    [RunInstaller(true)]
    public class AppInstaller : System.Configuration.Install.Installer
    {
        ...
        public AppInstaller()
        {
            ...
            installTools = new InstallTools(Const.HeartbeatName + " Setup", installFolder, "HeartbeatInstall.cmd");
            ...
            this.serviceInstaller.DisplayName      = Const.HeartbeatName;
            this.serviceInstaller.ServiceName      = Const.HeartbeatName;
            ...
            installTools.StartService(Const.HeartbeatName);

            // Add the service description to the registry.

            installTools.AddRegValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\" + Const.HeartbeatName + @":Description",
                                     "Performs periodic health checks of local websites.");
        }
        ...
        public override void Install(IDictionary state)
        {
            ...
            installTools.InstallIniFile("LillTek.Datacenter.HeartbeatService.ini");
            InstallPerfCounters();
            NativeSysLogProvider.CreateLogs(Const.HeartbeatName);
        }
        ...
        public override void Uninstall(IDictionary state)
        {
            try
            {
                PerformanceCounterCategory.Delete(Const.HeartbeatPerf);
                NativeSysLogProvider.RemoveLogs(Const.HeartbeatName);
            }
            catch
            {
                // Ignore any errors
