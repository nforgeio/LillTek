...
{
    /// <summary>
    /// Implements the Dynamic DNS service which is responsible for handling
    /// the dynamic registration of host/IP mappings and then making these
    /// available to legacy applications via standard DNS queries.
    /// </summary>
    /// <remarks>
    ...
    /// </para>
    /// <para>
    /// See <see cref="DynDnsHandler" /> for service specific settings.
    /// </para>
    /// </remarks>
