...
// DESCRIPTION: Implements the Authentication Service.
...
namespace LillTek.Datacenter.AuthService
{
    ...
    public sealed class AppService : ServiceBase, IService
    {
        ...
        private AuthServiceHandler  handler;        // The authentication service application handler
        ...
        public string Name
        {
            get { return Const.AuthServiceName; }
        }
