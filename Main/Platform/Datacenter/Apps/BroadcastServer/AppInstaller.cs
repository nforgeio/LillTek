...
// DESCRIPTION: Handles the installation of the Broadcast Server.
...
{
    /// <summary>
    /// Handles the installation of the Broadcast Server.
    /// </summary>
    [RunInstaller(true)]
    public class AppInstaller : System.Configuration.Install.Installer
    {
        ...
        public override void Install(IDictionary state)
        {
            ...
            installTools.InstallIniFile("LillTek.Datacenter.BroadcastServer.ini");
            InstallPerfCounters();
            NativeSysLogProvider.CreateLogs(Const.BroadcastServerName);
        }
        ...
        public override void Uninstall(IDictionary state)
        {
            try
            {
                PerformanceCounterCategory.Delete(Const.BroadcastServerPerf);
                NativeSysLogProvider.RemoveLogs(Const.BroadcastServerName);
            }
            catch
            {
                // Ignore any errors
