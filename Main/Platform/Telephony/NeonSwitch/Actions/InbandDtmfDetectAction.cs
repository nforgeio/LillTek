//-----------------------------------------------------------------------------
// FILE:        InbandDtmfDetectAction.cs
// CONTRIBUTOR: Jeff Lill
// COPYRIGHT:   Copyright (c) 2005-2015 by Jeffrey Lill.  All rights reserved.
// DESCRIPTION: Enables or disables the detection of in-band DTMF tones.
...
{
    /// <summary>
    /// Enables or disables the detection of in-band DTMF tones.
    /// </summary>
    /// <remarks>
    /// <note>
    /// In-band detection of DTMF tones is disabled by default for new calls.
    /// </note>
    /// </remarks>
    public class InbandDtmfDetectAction : SwitchAction
    {
        private bool enable;
        ...
        public InbandDtmfDetectAction(bool enable)
        {
            this.enable = enable;
        }
        ...
        /// <param name="enable">Pass <c>true</c> to enable in-band DTMF tones, <c>false</c> for out-of-band tones.</param>
        public InbandDtmfDetectAction(Guid callID, bool enable)
        {
            this.CallID = callID;
            this.enable = enable;
        }
        ...
        {
            var command = enable ? "start_dtmf" : "stop_dtmf";
