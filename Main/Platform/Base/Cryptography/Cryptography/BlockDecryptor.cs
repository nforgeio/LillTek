//-----------------------------------------------------------------------------
// FILE:        BlockDecryptor.cs
// CONTRIBUTOR: Jeff Lill
// COPYRIGHT:   Copyright (c) 2005-2015 by Jeffrey Lill.  All rights reserved.
// DESCRIPTION: Implements block decryption using a symmetric encryption algorithm.
...
{
    /// <summary>
    /// Implements block decryption using a symmetric encryption algorithm.
    /// </summary>
    /// <threadsafety instance="false" />
    public sealed class BlockDecryptor : IDisposable
    {
        ...
        /// <summary>
        /// Closes the decryptor, proactively releasing any asociated unmanaged resources.
        /// </summary>
        public void Dispose()
        {
            if (provider != null)
        ...
        /// <summary>
        /// Decrypts the input buffer passed and returns the result.
        /// </summary>
        /// <param name="input">The encrypted input.</param>
        ...
        /// <summary>
        /// Decrypts the specified range of bytes from the buffer passed.
        /// </summary>
        /// <param name="input">The encrypted input.</param>
        /// <param name="index">The starting index.</param>
        /// <param name="count">The number of bytes to encrypt.</param>
        /// <returns>The decrypted data.</returns>
        public byte[] Decrypt(byte[] input, int index, int count)
        {
            if (count == 0)
                return new byte[0];
