...
// DESCRIPTION: Implements the SHA256 algorithm to hash data into a digest.
...
// $todo(jeff.lill): 
//
// The SHA256/HMAC implementations are thrown in for completeness but
...
{
    /// <summary>
    /// Implements the SHA256 algorithm to hash data into a digest.
    /// </summary>
    public static class SHA256Hasher
    {
        /// <summary>
        /// Size of a SHA256 hashed digest in bytes.
        /// </summary>
        public const int DigestSize = 256 / 8;
        ...
        {
            return new SHA256Managed().ComputeHash(data, 0, data.Length);
        }
        ...
        {
            return new SHA256Managed().ComputeHash(data, pos, length);
        }

        /// <summary>
        /// Computes the SHA256 hash of a string encoded as UTF-8.
        /// </summary>
        ...
        /// <summary>
        /// Uses the HMAC/SHA256 algorithm to hash data from a stream.
        /// </summary>
        /// <param name="key">The secret key.</param>
        /// <param name="es">The input stream.</param>
        /// <param name="length">The number of bytes to hash.</param>
