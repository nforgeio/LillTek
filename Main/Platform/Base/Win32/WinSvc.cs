...
// DESCRIPTION: A low-level native Windows Service control API.
...
{
    /// <summary>
    /// A low-level native Windows Service control API.
    /// </summary>
    public class WinSvc
    {
        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern Handle LockServiceDatabase(Handle hSCManager);

        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool UnlockServiceDatabase(Handle hSCManager);

        [DllImport("kernel32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern void CopyMemory(Handle pDst, SC_ACTION[] pSrc, int ByteLen);

        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool ChangeServiceConfig(
            Handle hService, ServiceType dwServiceType, int dwStartType,
        ...
        public static extern bool ChangeServiceConfig2(
            Handle hService, InfoLevel dwInfoLevel,
        ...
        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern Handle OpenService(
            Handle hSCManager, string lpServiceName, ACCESS_TYPE dwDesiredAccess);

        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern Handle OpenSCManager(
        ...
        public static extern bool QueryServiceConfig(
            Handle hService, [MarshalAs(UnmanagedType.Struct)] ref QUERY_SERVICE_CONFIG lpServiceConfig, int cbBufSize,
             int pcbBytesNeeded);
