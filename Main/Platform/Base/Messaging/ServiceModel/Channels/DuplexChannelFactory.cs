...
{
    /// <summary>
    /// Implements a DuplexChannelFactory factory.
    /// </summary>
    internal sealed class DuplexChannelFactory : LillTekChannelFactory<IDuplexChannel, DuplexChannel>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="context">The <see cref="BindingContext" />.</param>
        public DuplexChannelFactory(BindingContext context)
            : base(context)
        {
        }
        ...
        protected override IDuplexChannel OnCreateChannel(EndpointAddress remoteAddress, Uri via)
        {
            ...
            channel = new DuplexChannel(this, null, remoteAddress, via, base.MessageEncoder);
