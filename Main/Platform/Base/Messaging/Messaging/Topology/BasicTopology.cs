//-----------------------------------------------------------------------------
// FILE:        BasicTopology.cs
// CONTRIBUTOR: Jeff Lill
// COPYRIGHT:   Copyright (c) 2005-2015 by Jeffrey Lill.  All rights reserved.
// DESCRIPTION: A simple plugable ITopologyProvider implementation that relies on
//              native LillTek Messaging capabilities. 
...
{
    /// <summary>
    /// A simple plugable <see cref="ITopologyProvider" /> implementation that relies on 
    /// native LillTek Messaging capabilities.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This class implements a very simple topology mechanism where the 
    /// cluster endpoint is just the common endpoint exposed by all service 
    /// instances and basic <see cref="MsgRouter" /> <see cref="MsgRouter.SendTo(MsgEP,Msg)" />,
    /// <see cref="MsgRouter.Query" /> and <see cref="MsgRouter.Broadcast" />
    /// functionality is used to distribute messages and queries across the
    /// service instances.
    /// </para>
    /// <para>
    /// The <b>param</b> parameter passed to the <b>Query</b>, <b>Broadcast</b>, and
    /// other client topology methods is ignored by this implementation.
    /// </para>
    /// <para><b><u>Topology Arguments</u></b></para>
    /// <para>
    /// <see cref="BasicTopology" /> does not require any additional arguments and ignores
    /// the <see cref="ArgCollection" /> parameter passed to the <see cref="OpenClient" />
    /// and <see cref="OpenServer" /> methods.
    /// </para>
    /// </remarks>
    public class BasicTopology : ITopologyProvider
    {
        ...
        {
            get { return TopologyCapability.None; }
        }
        ...
        public virtual void OpenClient(MsgRouter router, MsgEP clusterEP, ArgCollection args)
        {
            ...
            argsCopy                  = args != null ? args.Clone() : new ArgCollection();
        ...
        /// </summary>
        /// <remarks>
        /// The topology instance ID is used by implementations of the <c>LillTek.Datacenter.IReliableMessenger</c>
        ...
        /// to the <see cref="OpenClient" /> method with the addition of the "topology-type"
        /// argument.
        /// </para>
        /// </remarks>
        ...
        public ParallelQuery ParallelQuery(object param, ParallelQuery parallelQuery)
        {
            var ar = BeginParallelQuery(param, parallelQuery, null, null);
