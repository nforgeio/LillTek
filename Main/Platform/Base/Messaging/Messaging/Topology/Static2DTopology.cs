//-----------------------------------------------------------------------------
// FILE:        Static2DTopology.cs
// CONTRIBUTOR: Jeff Lill
// COPYRIGHT:   Copyright (c) 2005-2015 by Jeffrey Lill.  All rights reserved.
// DESCRIPTION: Implements a static two dimensional cluster topology.
...
{
    /// <summary>
    /// Implements a static two dimensional <see cref="ITopologyProvider" /> plug-in.
    /// </summary>
    /// <remarks>
    /// </remarks>
    public class Static2DTopology : ITopologyProvider
    {
        ...
        /// <summary>
        /// Returns a optology instance's globally unique ID.
        /// </summary>
        /// <remarks>
