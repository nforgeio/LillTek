...
namespace LillTek.Compression.Tar 
{
	...
	public class TarOutputStream : Stream
	{
		...
		/// <summary>
		/// <c>true</c> if the stream supports reading; otherwise, false.
		/// </summary>
		...
		/// <summary>
		/// <c>true</c> if the stream supports seeking; otherwise, false.
		/// </summary>
		...
		/// <summary>
		/// <c>true</c> if stream supports writing; otherwise, false.
		/// </summary>
		...
		/// </summary>
		/// <returns>The byte value or <b>-1</b> if at end of stream</returns>
