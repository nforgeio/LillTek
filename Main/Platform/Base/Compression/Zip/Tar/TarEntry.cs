...
namespace LillTek.Compression.Tar 
{
	...
	public class TarEntry : ICloneable
	{
		...
		/// </summary>
		/// <returns>
		/// <c>true</c> if the entries are equal.
		/// </returns>
		...
		/// </param>
		/// <returns>
		/// <c>true</c> if entry is a descendant of this.
		/// </returns>
		...
		/// <summary>
		/// Return <c>true</c> if this entry represents a directory, <c>false</c> otherwise
		/// </summary>
		/// <returns>
		/// <c>true</c> if this entry is a directory.
		/// </returns>
...
*/
		...
		public TarEntry[] GetDirectoryEntries()
		{
			...
			string[]   list   = Directory.EnumerateFiles(file).ToArray();
		...
		/// <summary>
        /// The name of the file this entry represents or <c>null</c> if the entry is not based on a file.
		/// </summary>
		string file;
