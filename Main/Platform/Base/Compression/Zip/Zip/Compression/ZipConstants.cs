...
#if MOBILE_DEVICE
        static Encoding defaultEncoding = Helper.ASCIIEncoding;
#else
		static Encoding defaultEncoding = CultureInfo.CurrentCulture.TextInfo.ANSICodePage;
#endif
#else
		static Encoding defaultEncoding = Encoding.GetEncoding(Thread.CurrentThread.CurrentCulture.TextInfo.OEMCodePage);
#endif
		
		/// <summary>
		/// Default encoding used for string conversion.
...
#if COMPACT_FRAMEWORK_V10 || COMPACT_FRAMEWORK_V20 || MOBILE_DEVICE
            return Helper.ASCIIEncoding.GetBytes(str);
#else
