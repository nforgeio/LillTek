...
namespace LillTek.Compression.Zip.Compression.Streams 
{
	...
	public class InflaterInputBuffer
	{
		...
		/// <summary>
		/// Read an 16-bit unsigned short in <b>little-endian</b> byte order.
		/// </summary>
		...
		/// <summary>
		/// Read a 32-bit integer in <b>little-endian</b> byte order.
		/// </summary>
	...
	/// as the <see cref="LillTek.Compression.GZip.GZipInputStream">GZipInputStream</see>.
	///
