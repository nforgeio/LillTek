...
namespace LillTek.Compression.Zip
{
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		/// <summary>
		/// Optional password used for encryption when non-<c>null</c>
		/// </summary>
		...
		/// </summary>
		/// <returns>
		/// The next <see cref="ZipEntry">entry</see> in the archive or <c>null</c> if there are no more entries.
		/// </returns>
		/// <remarks>
		...
		/// </summary>
		/// <param name="testCrc"><c>true</c> if the crc value should be tested</param>
		...
		/// </summary>
		/// <returns>
		/// The byte or <b>-1</b> if end of stream is reached.
		/// </returns>
		/// <exception name="System.IO.IOException">
		/// An i/o error occured.
		/// </exception>
		/// <exception name="LillTek.Compression.ZipException">
