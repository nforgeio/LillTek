...
namespace LillTek.Compression.Zip.Compression 
{
	...
	public class DeflaterEngine : DeflaterConstants 
	{
		...
		/// </summary>
		/// <returns>Returns <c>true</c> if progress has been made.</returns>
		...
		/// <summary>
		/// Return <c>true</c> if input is needed via <see cref="SetInput"> SetInput</see>
		/// </summary>		
...
*/
		...
		/// <returns><c>true</c> if a match greater than the minimum length is found</returns>
