...
namespace LillTek.Compression.Zip.Compression
{
	...
	public class Deflater
	{
		...
		*/
		...
		/// <summary>
		/// Returns <c>true</c> if the stream was finished and no more output bytes
		/// are available.
		/// </summary>
		...
		/// If you call setInput when needsInput() returns <c>false</c>, the
		...
		/// IsNeedingInput() or IsFinished returns <c>true</c> or length is zero.
		/// </returns>
		...
		/// <returns>
		/// The number of compressed bytes added to the output, or 0 if either
		/// needsInput() or finished() returns <c>true</c> or length is zero.
		/// </returns>
		/// <exception cref="System.InvalidOperationException">
