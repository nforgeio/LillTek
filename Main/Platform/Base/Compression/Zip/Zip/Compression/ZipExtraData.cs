...
namespace LillTek.Compression.Zip
{
	...
	sealed public class ZipExtraData : IDisposable
	{
        ...
        /// <returns>Returns a <see cref="Stream"/> containing tag data or <c>null</c> if no tag was found.</returns>
		...
		/// <returns>Returns <c>true</c> if the value was found; <c>false</c> otherwise.</returns>
		...
		/// <returns>Returns <c>true</c> if the field was found and deleted.</returns>
		...
		/// </summary>
		/// <returns>The byte value read or <b>-1</b> if the end of data has been reached.</returns>
		public int ReadByte()
		{
			int result = -1;
