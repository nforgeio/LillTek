...
namespace LillTek.Compression.Checksums 
{
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="LillTek.Compression.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="LillTek.Compression.Zip.Compression.Streams.DeflaterOutputStream"/>
