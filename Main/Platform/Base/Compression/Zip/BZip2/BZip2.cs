...
// LillTek.com: 
//
// Minor changes to the source files to change the namespace
// to LillTek.Compression.Zip and otherwise make them suitable
...
namespace LillTek.Compression.BZip2
{
