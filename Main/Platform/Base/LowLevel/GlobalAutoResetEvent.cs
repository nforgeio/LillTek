//-----------------------------------------------------------------------------
// FILE:        GlobalAutoResetEvent.cs
// CONTRIBUTOR: Jeff Lill
// COPYRIGHT:   Copyright (c) 2005-2015 by Jeffrey Lill.  All rights reserved.
// DESCRIPTION: This class implements a AutoResetEvent that can be named and used
//              across processes.
...
{
    /// <summary>
    /// This class implements a AutoResetEvent that can be named and used
    /// across processes.  For some reason, this capability was left out of 
    /// the .NET Framework class.
    /// </summary>
    public unsafe class GlobalAutoResetEvent
    {
        //---------------------------------------------------------------------
        // Implementation.  Methods are identical to those defined by AutoResetEvent.
        ...
        /// </param>
        public GlobalAutoResetEvent(string name)
        {
            ...
            retry:
                ...
                hEvent = WinApi.CreateEvent(sa.AttributesPtr, false, false, name);
        ...
        /// <summary>
        /// This constructor initializes the event, attempting to set the state of
        /// the event to the initial value passed.
        /// </summary>
        /// <param name="name">
        ...
        public GlobalAutoResetEvent(string name, bool requestedState, out bool actualState)
        {
            SafeWaitHandle      hEvent;
            SecurityAttributes  sa;
            int                 err;
            ...
            try
            {
                ...
                hEvent = WinApi.CreateEvent(sa.AttributesPtr, false, requestedState, name);
            ...
            this.name               = name;
            this.evt                = new AutoResetEvent(actualState);
            this.evt.SafeWaitHandle = hEvent;
        }
