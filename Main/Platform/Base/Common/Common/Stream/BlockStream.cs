...
// DESCRIPTION: Implement a stream on a collection of fragmented buffers.
...
{
    /// <summary>
    /// Implement a stream on a collection of fragmented buffers.
    /// </summary>
    /// <remarks>
    /// <note>
    /// Buffer array streams can not exceed 2GB in length.
    /// </note>
    /// </remarks>
    public sealed class BlockStream : Stream
    {
        private const string TooLongError = "Block streams cannot equal or exceed 2GB.";
