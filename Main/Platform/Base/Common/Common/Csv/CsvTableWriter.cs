...
// DESCRIPTION: Used to generate a CSV table.
...
namespace LillTek.Common
{
    ...
    public class CsvTableWriter : IDisposable
    {
        ...
        /// <summary>
        /// Constructs an instance to write to a file.
        /// </summary>
        /// <param name="columnHeaders">The table column names.</param>
        ...
        /// </note>
        /// </remarks>
        public CsvTableWriter(string[] columnHeaders, string path, Encoding encoding)
            : this(columnHeaders, new CsvWriter(path, encoding))
        {
        }
        ...
        /// </note>
        /// </remarks>
        public void Set(string columnName, Uri value)
        {
        ...
        /// </note>
        /// </remarks>
        public void Set(string columnName, bool value)
        {
            Set(columnName, Serialize.ToString(value));
        }
        ...
        /// </note>
        /// </remarks>
        public void Set(string columnName, IPAddress value)
        {
            Set(columnName, value != null ? Serialize.ToString(value) : string.Empty);
        }
        ...
        /// </note>
        /// </remarks>
        public void SetColumnBase64(string columnName, byte[] value)
        {
            Set(columnName, value != null ? Convert.ToBase64String(value) : string.Empty);
        }
    }
}
