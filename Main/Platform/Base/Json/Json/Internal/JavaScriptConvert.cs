...
using LillTek.Json.Internal.Utilities;
using LillTek.Json.Internal.Converters;
...
namespace LillTek.Json.Internal
{
	...
	internal static class JavaScriptConvert
	{
		...
		/// <summary>
		/// Converts the <see cref="DateTime"/> to its JavaScript string representation.
		/// </summary>
		...
		/// <summary>
		/// Converts the <see cref="Boolean"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Char"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Enum"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Int32"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Int16"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="UInt16"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="UInt32"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Int64"/>  to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="UInt64"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Single"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Double"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Byte"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="SByte"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Decimal"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		/// <returns>A Json string representation of the <see cref="SByte"/>.</returns>
		...
		/// <summary>
		/// Converts the <see cref="Guid"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="String"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
		...
		/// <summary>
		/// Converts the <see cref="Object"/> to its JavaScript string representation.
		/// </summary>
		/// <param name="value">The value to convert.</param>
