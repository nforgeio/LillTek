...
// DESCRIPTION: Handles the installation of the GeoTracker service.
...
{
    /// <summary>
    /// Handles the installation of the GeoTracker service.
    /// </summary>
    [RunInstaller(true)]
    public class AppInstaller : System.Configuration.Install.Installer
    {
        ...
        public AppInstaller()
        {
            ...
            installTools = new InstallTools(Const.GeoTrackerName + " Setup", installFolder, "GeoTrackerServiceInstall.cmd");
            ...
            this.serviceInstaller.DisplayName      = Const.GeoTrackerName;
            this.serviceInstaller.ServiceName      = Const.GeoTrackerName;
            ...
            installTools.StartService(Const.GeoTrackerName);

            // Add the service description to the registry.

            installTools.AddRegValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\" + Const.GeoTrackerName + @":Description",
                                     "Implements the GeoTracker server.");
        }
        ...
        public override void Uninstall(IDictionary state)
        {
            try
            {
                PerformanceCounterCategory.Delete(Const.GeoTrackerPerf);
                NativeSysLogProvider.RemoveLogs(Const.GeoTrackerName);
            }
            catch
            {
                // Ignore any errors
