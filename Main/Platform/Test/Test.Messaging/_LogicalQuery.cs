//-----------------------------------------------------------------------------
// FILE:        _LogicalQuery.cs
// CONTRIBUTOR: Jeff Lill
// COPYRIGHT:   Copyright (c) 2005-2015 by Jeffrey Lill.  All rights reserved.
// DESCRIPTION: Unit tests for Queries directed at logical endpoints
...
";
        ...
        public void LogicalQuery_Basic_Self()
        {
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_RequestContext()
        {
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_RequestContext_Orphaned()
        {
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Basic_Self_Blast()
        {
            _LeafRouter leaf = null;
            TestAck ack;
            string s;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Basic_Remote()
        {
            _LeafRouter leaf = null;
            _HubRouter hub = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Broadcast_Query()
        {
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_LongQuery_Self()
        {
            _HubRouter hub = null;
            TestAck ack;
            string s;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_LongQuery_Remote()
        {
            _LeafRouter leaf = null;
            _HubRouter hub = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Basic_Remote_Blast()
        {
            _LeafRouter leaf = null;
            _HubRouter hub = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Timeout_Self()
        {
            _LeafRouter leaf = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Timeout_Remote()
        {
            _LeafRouter leaf = null;
            _HubRouter hub = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Timeout_Self_Cached()
        {
            _LeafRouter leaf = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Timeout_Remote_Cached()
        {
            _LeafRouter leaf = null;
            _HubRouter hub = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Cached_Self()
        {
            _LeafRouter leaf = null;
            CachedMsg query;
            TestAck ack1;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Cached_Remote()
        {
            _HubRouter hub = null;
            _LeafRouter leaf = null;
            CachedMsg query;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_Exception()
        {
            _LeafRouter leaf = null;
            _HubRouter hub = null;
            TestAck ack;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_AsyncQuery()
        {
            _LeafRouter leaf = null;
            TestAck ack;
            DateTime start;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_AsyncQuery_AutoTimeout()
        {
            _LeafRouter leaf = null;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_AsyncQuery_Cancel()
        {
            _LeafRouter leaf = null;
            DateTime start = SysTime.Now;
        ...
        [TestMethod]
        [TestProperty("Lib", "LillTek.Messaging")]
        public void LogicalQuery_AsyncQuery_Abort()
        {
            _LeafRouter leaf = null;
            DateTime start = SysTime.Now;
